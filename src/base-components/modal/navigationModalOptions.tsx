...
function webOptions<T extends object>(
...
function navigationModalOptions<T extends object>(
  navigation: NavigationProp<T>,
  theme: Theme,
  height: number,
  insets: EdgeInsets,
  ...
  return Platform.OS !== 'web' || forceModal
    ? mobileOptions(height, insets, modalHeight)
    : webOptions<T>(navigation, theme, headerTitle);
}
